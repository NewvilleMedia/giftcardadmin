...
export function Header({
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-gray-200/80 bg-white/80 px-6 backdrop-blur-sm">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative hidden md:block">
          ...
          <input
            ...
            placeholder="Search..."
            className={cn(
              "w-64 rounded-lg border border-gray-200 bg-gray-50 py-2 pl-10 pr-4 text-sm text-gray-900",
        ...
        <div ref={dropdownRef} className="relative">
          ...
          >
            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 text-xs font-semibold text-white shadow-sm">
              {initials}
            </div>
          ...
          {/* Dropdown menu */}
          {profileOpen && (
            <div className="absolute right-0 top-full mt-2 w-56 origin-top-right rounded-xl border border-gray-200 bg-white py-1 shadow-lg">
